...
public class MoreWebsites extends MyActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView5 = findViewById(R.id.textView05);
    ...
    private void loadWebsiteFromFireStore() {
        ...
        db.collection("websites").document("one").collection("websites")
        ...
        db.collection("websites").document("two").collection("websites")
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    @Override
                    public void onEvent(@Nullable QuerySnapshot querySnapshot,
                                        @Nullable FirebaseFirestoreException e) {
        ...
        db.collection("websites").document("three").collection("websites")
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    @Override
                    public void onEvent(@Nullable QuerySnapshot querySnapshot,
                                        @Nullable FirebaseFirestoreException e) {
        ...
        db.collection("websites").document("four").collection("websites")
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    @Override
                    public void onEvent(@Nullable QuerySnapshot querySnapshot,
                                        @Nullable FirebaseFirestoreException e) {
        ...
        db.collection("websites").document("five").collection("websites")
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    @Override
                    public void onEvent(@Nullable QuerySnapshot querySnapshot,
                                        @Nullable FirebaseFirestoreException e) {
